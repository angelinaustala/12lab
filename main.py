...
def ypr1():
    ...
    f = ['Клубничный', 'Мятный', 'Банановый', 'Шоколадный']

    r = IceCreamStand('ICE CREAM', 'Итальянская', f, 'ул. Новоселова 106 ', '10:00 - 21:00')
...
def ypr2():
    ...
    r = Restaurant('ICE CREAM', 'Итальянская', f, 'ул. Новоселова 106 ', '10:00 - 21:00')
    r.describe_rest()
    ...
    i.geometry('230x260')
    frame = Frame(i, bg = 'light pink', bd = 5)
    frame.place(relx=0.15, rely = 0.15, relwidth = 0.7, relheight = 0.7)
    title = Label(i, text = 'Виды мороженного:', bg = 'light pink', font = 30)
    ...
    for k in f:
        e = k
        ch += 0.12
        m = Label(i, text = e, bg = 'light pink', font = 25)
